      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Have questions about your order, need book recommendations, or want to share feedback? 
              We're here to help!
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">contact@bookstore.com</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">We'll respond within 24 hours</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Mon-Fri from 9am to 6pm EST</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  SSPKM Boy's Hostel <br />
                  Kokilaben Vyas Marg,<br />
                  opp. pankaj Vidhyalaya,<br /> 
                  near BSNL Office, Ellisbridge,<br /> 
            ...
            <div className="mt-8">
              <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Follow Us</h3>
        ...
        <div className="md:col-span-2">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            {status.submitted && (
              <div className={`mb-6 p-4 rounded-md ${status.success ? 'bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400'}`}>
                {status.message}
              </div>
            )}
